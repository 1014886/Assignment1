package com.yash.spring_core_assignment_.Q13;
...
public class MovieDetailsTest {
	public static void main(String[] args) {
		ApplicationContext ctxobj = new ClassPathXmlApplicationContext("com/yash/spring_core_assignment_/Q13/myFile.xml");
