package com.yash.spring_core_assignment_.Q12;
...
public class EmpTest {
	public static void main(String[] args) throws Exception {
		...
		ApplicationContext ctxobj = new ClassPathXmlApplicationContext("com/yash/spring_core_assignment_/Q12/myFile.xml");
